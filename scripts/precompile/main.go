...
func main() {
	ec, err := ethclient.Dial("http://127.0.0.1:32725/ext/bc/nA2gxunf9oofZtC9DqXcKzqbrVBssqaGZYSnQq6eSbxfg38RK/rpc")
	panicErr(err)
	...
	fit_tx, err := testContract.TestFit(user, []*big.Int{big.NewInt(10), big.NewInt(2), big.NewInt(2)})
	panicErr(err)
